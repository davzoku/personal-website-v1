...
There are plenty of useful open-source tools to generate ADR templates and manage the decision logs. For example, I have selected [phodal/adr](https://github.com/phodal/adr) as [my tool of choice](https://github.com/davzoku/personal-website-v1/blob/main/docs/adr/0008-adr-tooling.md) to maintain the ADRs for my personal website. Alternatively, you may opt to use any existing team collaboration tools like Confluence.
...
The decision logs for my project can also be found [here](https://github.com/davzoku/personal-website-v1/tree/main/docs/adr).
