...
published: true
type: ["Note"]
tags: ["Code", "Design", "Figma", Singapore"]
cover: ./cover.png
...
Additionally, if we have any SVG that we want to toggle alongside with the themes, we can change the fill attribute to take in the CSS variable.
