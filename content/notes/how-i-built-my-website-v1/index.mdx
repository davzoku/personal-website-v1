...
- Added [Docker support for cross-platform local development](/garden/gatsby-docker)
...
- Added [Theme Switcher](/garden/theme-switcher-sg) feature to support dark mode and much more
