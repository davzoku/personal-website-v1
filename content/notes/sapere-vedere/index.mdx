...
_P.S. I found a similar quote to Julie Zhuo's tweet._

_As we know, [There are known knowns](https://en.wikipedia.org/wiki/There_are_known_knowns). These are things we know that we know. There are known unknowns. That is to say, there are things that we know we don’t know. But there are also unknown unknowns. There are things we don’t know we don’t know._
