...
> This is my preferred choice as git bash is easier for me to maintain due to the [differences in the file directory with WSL](https://superuser.com/questions/1471994/git-bash-and-wsl-have-a-different-directory-structure). Most of files are stored in the Windows file system and I use [Chocolatey](https://chocolatey.org/) to manage my installation packages.
