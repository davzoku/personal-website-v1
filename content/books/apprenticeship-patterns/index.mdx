...
description: "Book Summary of Apprentice Patterns"
published: true
type: ["Book"]
...
redirects:
  - "/library/apprenticeship-patterns"
  - "/library/apprenticeship-patterns/"
---
...
1. [Have a growth mindset](/growth-mindset)
...
To move forward, have childlike thinking. Cultivate a [beginner's mindset](/better-mindsets#beginners-mindset). For example, take a program you have written in one programming paradigm (e.g.,
...
Take steps to protect and grow your passion for software craftsmanship. Work on what you like, be it at work or during your free time. Create / join a like-minded group (using [Knowledge Hydrant patterns](/knowledge-hydrant)) or build side projects.
