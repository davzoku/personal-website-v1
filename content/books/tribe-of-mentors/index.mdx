...
author: "Tim Ferris"
description: "Book Summary of Tribe of Mentors"
published: true
type: ["Book"]
tags: ["Mentor", "Advice"]
cover: ./cover.jpg
...
<SpotifySingleEmbed src="https://open.spotify.com/embed/episode/07HRIevDwmDY5XDXxGwz6l" />
...
Ferris' words hit me. Just a week back, I had the idea of [Question-based Personal Knowledge Management](/personal-knowledge-management#question-based-pkm). The plan is to collect all the random questions I have in a single list and attempt to answer them with what I can find. The initial list is long and I will probably share further as time goes.
...
I like how he describes the adult world and it is similar to Ravikant's [opinion](/tribe-of-mentors#on-bad-recommendation-1).
...
> **Interestingly, [Work With Source](https://workwithsource.com/) made some [clarification](https://workwithsource.com/2017/12/20/source-mentioned-in-tim-ferriss-new-book/) on Duncan's statements.**
>
...
This is similar to having an [Outward Mindset](/better-mindsets#outward-mindset-vs-inward-mindset).
...
> the belief that we are all mini gods... the entire universe is not just outside but also within us ... Being mini gods means we never lack. We know we already have everything. We don’t need a million dollars. We don’t need a trillion followers. We are complete. We are full.
