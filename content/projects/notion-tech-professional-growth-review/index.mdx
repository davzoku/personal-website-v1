...
In addition, I added an extra section for me to add at least three actionable items after the review to get things going. For example, some of my actionable items include building [breakable toys](/apprenticeship-patterns#breakable-toys).
